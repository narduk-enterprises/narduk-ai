...
/**
 * Return a Drizzle ORM instance for the app schema.
 *
 * Uses a separate memoization slot from the layer helper so app-specific tables
 * stay typed and queryable without mutating the shared layer implementation.
 */
