 ...
 *
 * Keeps `narduk-ai` (Level 1 Fleet Hub) in sync with
 * `0_global-canonical-tokens` (Level 0 Canonical Hub).
 *
 * Because Doppler blocks daisy-chaining references, narduk-ai
 ...
 * into narduk-ai's dev and prd configs.
 *
 * Usage:
