...
const HUB_KEYS: Record<string, string> = {
  CLOUDFLARE_API_TOKEN: 'narduk-ai',
  CLOUDFLARE_ACCOUNT_ID: 'narduk-ai',
...
function main() {
  ...
  console.log('         hub=all hub keys are cross-refs to narduk-ai / narduk-analytics')
  console.log()
}
